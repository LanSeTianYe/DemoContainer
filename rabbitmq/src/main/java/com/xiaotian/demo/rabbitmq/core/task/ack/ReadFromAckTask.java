...
public class ReadFromAckTask implements Runnable {


    private static Logger log = LoggerFactory.getLogger(ReadFromAckTask.class);
    ...
    public ReadFromAckTask(Channel channel, String queueName) {
    ...
    private class ReadFromDefTaskConsumer implements Consumer {
        ...
        public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
            ...
            log.info("ReadFromAckTask, exchange:{}, queue:{}, routingKey:{}, deliveryTag:{}, consumerTag:{}, newCount:{}, totalCount:{}", envelope.getExchange(), queueName, envelope.getRoutingKey(), envelope.getDeliveryTag(), consumerTag, newCount, totalCount);
        }
    }
