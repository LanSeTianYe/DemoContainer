...
public class MybatisPlusGenerateStarter {

    private static final String PROJECT_PATH = "D:\\work\\hades\\hades\\hades-core\\";
    private static final String PACKAGE_NAME = "com.egls.cashloan.hades.core";
    public static final String MODEL = "sys";
    private static final String TABLES = "arc_sys_menu,arc_sys_menu_perm,arc_sys_perm,arc_sys_role,arc_sys_role_menu,,arc_sys_role_perm,arc_sys_user,arc_sys_user_role";
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                String path = PROJECT_PATH + "/src/main/resources/mapper/" + packageInfo.getModuleName() + "/";
