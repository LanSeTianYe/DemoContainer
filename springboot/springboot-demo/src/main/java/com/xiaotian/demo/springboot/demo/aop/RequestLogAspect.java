package com.xiaotian.demo.springboot.transactional.aop;
...
public class RequestLogAspect {
    ...
    @Pointcut("execution(public com.xiaotian.demo.springboot.transactional.common.HttpResult com.sun.xiaotian.demo.springboot.*.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
