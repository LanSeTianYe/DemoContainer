package com.xiaotian.demo.springboot.demo.aop;
...
public class RequestLogAspect {
    ...
    @Pointcut("execution(public com.xiaotian.demo.springboot.demo.common.HttpResult com.sun.xiaotian.demo.springboot.*.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
